...
var Ad = {
  ...
  addContent: function() {
    ...
    if (myFT.instantAds.F1_subHeadline_txt==""){
        ...
        styles.innerHTML = "#textBlockF1a > div:last-child::after { content: '"+ Ad.changeSuperScript(myFT.instantAds.F1_subHeadline_txt) +"';color:"+ myFT.instantAds.F1_subHeadline_size_hex.split('|')[1] +";text-align: right;font-size: "+ myFT.instantAds.F1_subHeadline_size_hex.split('|')[0] +"px;display: block;margin-right: 1.5em; margin-top: -0.3em;letter-spacing: 0.02em; font-family: 'SoDoSansRegular';}"
    }
    if (myFT.instantAds.F2_subHeadline_txt==""){
        ...
        styles.innerHTML = "#textBlockF2a > div:last-child::after { content: '"+ Ad.changeSuperScript(myFT.instantAds.F2_subHeadline_txt) +"';color:"+ myFT.instantAds.F2_subHeadline_size_hex.split('|')[1] +";text-align: right;font-size: "+ myFT.instantAds.F2_subHeadline_size_hex.split('|')[0] +"px;display: block;margin-right: 1.5em; margin-top: -0.3em;letter-spacing: 0.02em; font-family: 'SoDoSansRegular';}"
    }
    ...
    animate: function() {
        TweenLite.set(document.getElementById('textBlockF2'),{opacity:1,y:80});
        TweenLite.set(document.getElementById('textBlockF3'), {opacity:1,y:90});
        ...
        TweenLite.from(document.getElementById('textBlockF1'), 0.25, {autoAlpha: 0, y: +80, delay: 1.5});
        
        TweenLite.to(document.getElementById('textBlockF1'), 0.5, {opacity:1, y:+80, delay: 4});
        TweenLite.to(document.getElementById('textBlockF2'), 0.5, {opacity:1, y:0, delay: 4.5});
        
        TweenLite.to(document.getElementById('textBlockF2'), 0.5, {opacity:1, y:+80, delay: 7.5});
