...
var Ad = {
  ...
  addContent: function() {
    ...
    if (myFT.instantAds.F2_headline2_txt === "") {
      ...
      styles.innerHTML = "#headline-2a > span:last-child { display: inline-block; position: relative; } #headline-2a > span:last-child::after { content: '"+ Ad.changeSuperScript(myFT.instantAds.F2_subHeadline_txt) +"';color:"+ myFT.instantAds.F2_subHeadline_size_hex.split('|')[1] +";text-align: right;font-size: "+ myFT.instantAds.F2_subHeadline_size_hex.split('|')[0] +"px;display: block;margin-right: 1.14em; margin-top: -1.1em; position: absolute; right: 0; letter-spacing: 0.02em; font-family: 'SoDoSansRegular';}"
    }
    else {
...
if(myFT.instantAds.F2_subHeadline_txt !== ""){
  document.getElementById('headlineCont').style.paddingBottom = "8px";
}
    ...
    if(navigator.platform.indexOf("Win")>-1){
      headline1.style.marginTop = "0.01em";
      document.getElementById('headlineCont').style.marginTop = "0.1em";
    }     
  ...
  animate: function() {
    TweenLite.from(document.getElementById('headline-1'), 0.25, {autoAlpha: 0, y: '90px', delay: 0.5});
    TweenLite.from(document.getElementById('content'), 0.25, {autoAlpha: 0, y: '90px', ease: Power2.easeInOut, delay: 3.35,});
    TweenLite.to(document.getElementById('headline-1'), 0.85, {
      autoAlpha: 0, 
      y: '90px', 
