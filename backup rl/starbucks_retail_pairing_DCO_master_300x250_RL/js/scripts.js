...
var Ad = {
  ...
  addContent: function() {
    ...
    animate: function() {
        ...
        TweenLite.set(product1,{opacity:0,x:0+Number(myFT.instantAds.start_product1_offsetX_offsetY.split("|")[0]),y:110+Number(myFT.instantAds.start_product1_offsetX_offsetY.split("|")[1]),width:300,height:300});
        TweenLite.set(product2,{opacity:0,x:300,y:110+Number(myFT.instantAds.start_product2_offsetX_offsetY.split("|")[1]),width:300,height:300});
        TweenLite.set(document.getElementById('textBlockF2'),{x:300});
        ...
        TweenLite.from(document.getElementById('textBlockF1'), 0.25, {autoAlpha: 0, y: +30, delay: 2});

        TweenLite.to(document.getElementById('textBlockF1'), 0.5, {x:-300, delay: 4});
        TweenLite.to(document.getElementById('textBlockF2'), 0.5, {x:0, delay: 4});

        TweenLite.to(product1,0.5, {x:-300,delay: 4});
        TweenLite.to(product2,0.5, {x:0+Number(myFT.instantAds.start_product2_offsetX_offsetY.split("|")[0]),delay: 4});
  
        TweenLite.to(product1, 1, {x:-105+Number(myFT.instantAds.end_product1_offsetX_offsetY.split("|")[0]),y:19+Number(myFT.instantAds.end_product1_offsetX_offsetY.split("|")[1]),width:210,height:210,ease: Power2.easeInOut, delay:7.5});
        TweenLite.to(product2, 1, {x:195+Number(myFT.instantAds.end_product2_offsetX_offsetY.split("|")[0]),y:19+Number(myFT.instantAds.end_product2_offsetX_offsetY.split("|")[1]),width:210,height:210,ease: Power2.easeInOut, delay:7.5});

        TweenLite.to(document.getElementById('textBlockF2'), 1, {x:150+Number(myFT.instantAds.end_product2_offsetX_offsetY.split("|")[0]),y:-91+Number(myFT.instantAds.end_product2_offsetX_offsetY.split("|")[1]),scale:0.7,opacity:1,ease: Power2.easeInOut, delay:7.5});
        TweenLite.to(document.getElementById('textBlockF2'), 0.1, {opacity: 0, delay:8.2});
