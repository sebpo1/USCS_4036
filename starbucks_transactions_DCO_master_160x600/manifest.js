FT.manifest({
  ...
  "richLoads": [
    {
      "name": "richload1",
      "src": "starbucks_retail_pairing_DCO_master_160x600_RL/index.html"
    }
  ],
  "instantAds": [
    {
    ...
    },
    {
      ...
      "type": "text",
      "default": "New<br/>Iced Cherry<br/>Chai"
    },
    {
      "name": "F2_headline1Txt_size_hex",
      "type": "text",
      "default": "17|#32462f|transparent"
    },
    {
    ...
    },
    {
      "name": "clickTag1_url",
      "type": "text",
      "default": "https://starbucks.app.link/pjGHX4jnAab?%243p=a_custom_745318880125383532&~customer_placement=[%FT_PLACEMENT_ID%]&~campaign=fy23falldco&~creative_name=icedcaramelmacchiato"
    },
    {
      "name": "clickTag2_url",
      "type": "text",
    ...
    },
    {
      "name": "product1_img",
      "type": "image",
      "default": "VanillaBeanCustardDanish_Green_600x600_PAIRING.png"
    },
    {
      "name": "product2_img",
      "type": "image",
      "default": "IcedCherryChai_GreenIcedCherryChai_Green_600x600_PAIRING.png"
    },
    {
      "name": "logo_img",
      "type": "image",
      "default": "starbucks_logo.svg"
    },
    {
      "name": "background_img",
      "type": "image",
      "default": "FY25-SUM1-RM-Background_160x600.jpg"
    },
    {
      "name": "richload1",
      "type": "richLoad"
