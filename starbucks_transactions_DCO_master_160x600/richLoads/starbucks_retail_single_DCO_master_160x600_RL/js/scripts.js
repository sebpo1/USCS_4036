...
var Ad = {
  ...
  addContent: function() {
    ...
    if (myFT.instantAds.F2_headline2_txt === "") {
      ...
      styles.innerHTML = "#headline-2a > span:last-child { display: inline-block; position: relative; } #headline-2a > span:last-child::after { content: '"+ Ad.changeSuperScript(myFT.instantAds.F2_subHeadline_txt) +"';color:"+ myFT.instantAds.F2_subHeadline_size_hex.split('|')[1] +";text-align: right;font-size: "+ myFT.instantAds.F2_subHeadline_size_hex.split('|')[0] +"px;display: block;margin-right: 1.3em; position: absolute; right: 0; letter-spacing: 0.02em; font-family: 'SoDoSansRegular'; line-height: 1.1em;}"
    }
    else {
