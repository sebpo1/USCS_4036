...
var Ad = {
  ...
  addContent: function() {
    ...
    animate: function() {
        ...
        TweenLite.set(product1,{opacity:0,x:-100+Number(myFT.instantAds.start_product1_offsetX_offsetY.split("|")[0]),y:300+Number(myFT.instantAds.start_product1_offsetX_offsetY.split("|")[1]),width:500,height:500});
        TweenLite.set(product2,{opacity:0,x:450,y:300+Number(myFT.instantAds.start_product2_offsetX_offsetY.split("|")[1]),width:500,height:500});
        TweenLite.set(document.getElementById('textBlockF2'),{x:600});
        ...
        TweenLite.from(document.getElementById('textBlockF1'), 0.5, {y: +90, delay: 1.5});

        TweenLite.to(document.getElementById('textBlockF1'), 0.5, {x:-450, delay: 4});
        TweenLite.to(document.getElementById('textBlockF2'), 0.5, {x:0, delay: 4});
        TweenLite.to(product1,0.5, {x:-450,delay: 4});
        TweenLite.to(product2,0.5, {x:-100+Number(myFT.instantAds.start_product2_offsetX_offsetY.split("|")[0]),delay: 4});

        TweenLite.to(product1, 1, {x:-125+Number(myFT.instantAds.end_product1_offsetX_offsetY.split("|")[0]),y:40+Number(myFT.instantAds.end_product1_offsetX_offsetY.split("|")[1]),width:250,height:250,ease: Power2.easeInOut, delay:7});
        TweenLite.to(product2, 1, {x:175+Number(myFT.instantAds.end_product2_offsetX_offsetY.split("|")[0]),y:40+Number(myFT.instantAds.end_product2_offsetX_offsetY.split("|")[1]),width:250,height:250,ease: Power2.easeInOut, delay:7});

        TweenLite.to(document.getElementById('textBlockF2'), 1, {x:145+Number(myFT.instantAds.end_product2_offsetX_offsetY.split("|")[0]),y:-215+Number(myFT.instantAds.end_product2_offsetX_offsetY.split("|")[1]),scale:0.5,opacity:1,ease: Power2.easeInOut, delay:7});
