...
var Ad = {
  ...
  addContent: function() {
    ...
    if (myFT.instantAds.F2_headline2_txt === "") {
      ...
      styles.innerHTML = "#headline-2a > span:last-child { display: inline-block; position: relative; } #headline-2a > span:last-child::after { content: '"+ Ad.changeSuperScript(myFT.instantAds.F2_subHeadline_txt) +"';color:"+ myFT.instantAds.F2_subHeadline_size_hex.split('|')[1] +";text-align: center;font-size: "+ myFT.instantAds.F2_subHeadline_size_hex.split('|')[0] +"px;display: block;  position: absolute; letter-spacing: 0.02em; font-family: 'LanderShort-Regular';}"
    }
    else {
    ...
    if(myFT.instantAds.F2_subHeadline_txt !== ""){
      document.getElementById('headlineCont').style.paddingBottom = "3px";
      document.getElementById('headlineCont').style.marginTop = "0px";
    }
